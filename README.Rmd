...
Lastly, geocode_address() takes one address as an argument and no more, so something like this will also fail.  
...
If you find a bug, please file a reproducible example on [GitHub](https://github.com/WarbyParker/cbsafinder).
