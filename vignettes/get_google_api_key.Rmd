...
Now, restrict your API key only geocoding api by going to api & services, clicking the pencil on your api key, and under "API restrictions" clicking "restrict key" and selecting the geocoding api.  

To make sure you don't go over the limit and get charged, you can set quotas for your usage. Follow the steps on "Manage your cost of use" on [this page](https://developers.google.com/maps/documentation/geocoding/usage-and-billing?hl=en_US). Note "Advanced maps load card" (step 5) doesn't exist - instead click all of the things you see and edit the quota limits in each to be 1200 or lower per day. 
